...
public interface ComponentDir extends Component {
    ...
    default void validateDirIs(String value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getDir(), value, "dir");
    }
    ...
    default void validateDirIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getDir(), "dir");
    }
