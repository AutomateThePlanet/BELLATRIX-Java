...
public interface ComponentSize extends Component {
    ...
    default void validateSizeIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getSizeAttribute(), "size");
    }
    ...
    default void validateSizeIs(int value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getSizeAttribute(), value, "size");
    }
}
