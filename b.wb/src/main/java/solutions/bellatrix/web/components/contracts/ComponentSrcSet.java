...
public interface ComponentSrcSet extends Component {
    ...
    default void validateSrcSetIs(String value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getSrcSet(), value, "srcset");
    }
    ...
    default void validateSrcSetIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getSrcSet(), "srcset");
    }
