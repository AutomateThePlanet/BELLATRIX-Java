...
public interface ComponentAccessKey extends Component {
    ...
    default void validateAccessKeyIs(String value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getAccessKey(), value, "accesskey");
    }
    ...
    default void validateAccessKeyIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getAccessKey(), "accesskey");
    }
