...
//  1. This is the attribute for automatic start/control of WebDriver browsers by BELLATRIX. If you have to do it
//  manually properly, you will need thousands of lines of code.
//  1.1 Browser controls which browser is used. Available options are:
//  Chrome, Firefox, Edge, Opera, Safari, Internet Explorer, Chrome in headless mode, Edge in headless mode, Firefox
//  in headless mode.
...
//  RESTART_EVERY_TIME – for each test a separate WebDriver instance is created and the previous browser is closed.
//  The new browser comes with new cookies and cache.
...
public class BellatrixBrowserBehaviourTests extends WebTest {
    // 1.3 All web BELLATRIX test classes should inherit from the WebTest base class. This way you can use all built-in
