...
import solutions.bellatrix.playwright.components.advanced.grid.GridRow;
...
public class GridControlTests extends WebTest {
    ...
    public void verifyRowElement_When_ForEachRow() {
        testGrid.forEachRow(row -> row.create().byXpath(Button.class, ".//input[@type='button']").validateIsVisible());
    }
