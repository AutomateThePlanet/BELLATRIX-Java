...
public class Map extends PageMap {
    ...
    public TextInput riskAssessmentNumberSearchInput() {
        return create().byXPath(TextInput.class, "//table[@id='x_nuvo_cs_risk_assessment_table']//input[contains(@aria-label,'number')]");
    }
    ...
    public Button assetVulnerabilitiesTab() {
        return create().byXPath(Button.class, "(//span[@class='tab_header']//span[contains(text(), 'Asset')])[2]");
    }
