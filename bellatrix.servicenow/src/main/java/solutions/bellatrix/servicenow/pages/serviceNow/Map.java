...
public class Map extends PageMap {
    ...
    public Button showColumnSearchRow() {
        var xpathLocator = "//table[@id='x_nuvo_nps_critical_date_table']/descendant::span[text()='Show column search row']/parent::button/parent::div";
        return create().byXPath(Button.class, xpathLocator);
    }

    public Button hideColumnSearchRow() {
        var xpathLocator = "//table[@id='x_nuvo_nps_critical_date_table']/descendant::span[text()='Hide column search row']/parent::button/parent::div";
        return create().byXPath(Button.class, xpathLocator);
    }

    // Polaris Mode Related Elements:
    ...
    public TextArea deviceInstallStatusField() {
        return create().byXPath(TextArea.class, "//input[@id='sys_readonly.x_nuvo_eam_clinical_devices.install_status']");
    }
