...
public class MobileScreenshotPlugin extends ScreenshotPlugin {
    ...
    public static MobileScreenshotPlugin of() {
        Boolean isEnabled = ConfigurationService.get(MobileSettings.class).getScreenshotsOnFailEnabled();
    ...
    protected String getOutputFolder() {
        String saveLocation = ConfigurationService.get(MobileSettings.class).getScreenshotsSaveLocation();
