...
public class MobileVideoPlugin extends VideoPlugin {
    ...
    public static MobileVideoPlugin of() {
        Boolean isEnabled = ConfigurationService.get(MobileSettings.class).getVideosOnFailEnabled();
        return new MobileVideoPlugin(isEnabled);
    }

    @Override
    protected String getOutputFolder() {
        String saveLocation = ConfigurationService.get(MobileSettings.class).getVideosSaveLocation();
