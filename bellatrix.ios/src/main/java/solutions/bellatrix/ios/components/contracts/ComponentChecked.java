...
public interface ComponentChecked extends Component {
    ...
    default void validateIsChecked() {
        ...
        method.invoke(SingletonFactory.getInstance(IOSValidator.class), (IOSComponent)this, isChecked(), "checked");
    }

    @SneakyThrows
    default void validateIsUnchecked() {
        Method method = IOSValidator.class.getDeclaredMethod("defaultValidateAttributeTrue", IOSComponent.class, boolean.class, String.class);
        method.invoke(SingletonFactory.getInstance(IOSValidator.class), (IOSComponent)this, !isChecked(), "unchecked");
    }
}
