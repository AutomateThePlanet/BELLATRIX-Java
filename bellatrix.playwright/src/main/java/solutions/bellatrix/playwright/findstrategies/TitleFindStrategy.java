...
import solutions.bellatrix.playwright.findstrategies.options.TitleOptions;
import solutions.bellatrix.playwright.findstrategies.utils.By;

import java.util.regex.Pattern;

@Getter
public class TitleFindStrategy extends PatternStrategy {
    public TitleFindStrategy(String text) {
        this.text = text;
    }

    public TitleFindStrategy(Pattern pattern) {
        this.pattern = pattern;
    }

    public TitleFindStrategy(String text, TitleOptions options) {
        this.text = text;
        this.options = options;
    }

    public TitleFindStrategy(Pattern pattern, TitleOptions options) {
        this.pattern = pattern;
        this.options = options;
    }
