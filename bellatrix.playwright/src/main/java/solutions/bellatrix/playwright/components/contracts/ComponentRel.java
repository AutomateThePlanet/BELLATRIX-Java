...
public interface ComponentRel extends Component {
    ...
    default void validateRelIs(String value) {
        ComponentValidator.defaultValidateAttributeIs((WebComponent)this, this::getRel, value, "rel");
    }

    default void validateRelIsSet() {
        ComponentValidator.defaultValidateAttributeIsSet((WebComponent)this, this::getRel, "rel");
    }

    default void validateRelNotSet() {
        ComponentValidator.defaultValidateAttributeNotSet((WebComponent)this, this::getRel, "rel");
    }
}
