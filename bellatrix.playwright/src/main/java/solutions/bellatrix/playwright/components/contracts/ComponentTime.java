...
public interface ComponentTime extends Component {
    ...
    default void validateTimeIs(String value) {
        ComponentValidator.defaultValidateAttributeIs((WebComponent)this, this::getTime, value, "time");
    }

    default void validateTimeContains(String value) {
        ComponentValidator.defaultValidateAttributeContains((WebComponent)this, this::getTime, value, "time");
    }

    default void validateTimeNotContains(String value) {
        ComponentValidator.defaultValidateAttributeNotContains((WebComponent)this, this::getTime, value, "time");
    }
}
