...
import components.common.create.RelativeCreateService;
import components.common.validate.Validator;
import components.contracts.Component;
import components.contracts.ComponentVisible;
import components.options.actions.*;
import components.options.states.BoundingBoxOptions;
import configuration.WebSettings;
import findstrategies.*;
import findstrategies.FindStrategy;
import findstrategies.options.*;
import infrastructure.BrowserChoice;
import infrastructure.PlaywrightService;
import infrastructure.WrappedBrowser;
...
public class WebComponent extends LayoutComponentValidationsBuilder implements Component, ComponentVisible {
    ...
    protected Locator wrappedElement;
    ...
    public WebComponent(Locator locator) {
    ...
    public Locator wrappedElement() {
        return wrappedElement;
    }

    public void wrappedElement(Locator element) {
    ...
    public <TElementType extends WebComponent> TElementType toBeVisible() {
        PlaywrightAssertions.assertThat(wrappedElement).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(webSettings.getTimeoutSettings().inMilliseconds().getElementToBeVisibleTimeout()));
        return (TElementType)this;
    }

    public <TElementType extends WebComponent> TElementType toNotBeVisible() {
        PlaywrightAssertions.assertThat(wrappedElement).not().isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(webSettings.getTimeoutSettings().inMilliseconds().getElementNotToBeVisibleTimeout()));
        return (TElementType)this;
    }
    ...
    public <TElementType extends WebComponent> TElementType toBeDisabled() {
        PlaywrightAssertions.assertThat(wrappedElement).isDisabled(new LocatorAssertions.IsDisabledOptions().setTimeout(webSettings.getTimeoutSettings().inMilliseconds().getValidationsTimeout()));
        return (TElementType)this;
    }

    public <TElementType extends WebComponent> TElementType toHaveContent() {
        PlaywrightAssertions.assertThat(wrappedElement).not().isEmpty(new LocatorAssertions.IsEmptyOptions().setTimeout(webSettings.getTimeoutSettings().inMilliseconds().getElementToHaveContentTimeout()));
        return (TElementType)this;
    }
    ...
    public <TElementType extends WebComponent> TElementType toBeVisible(long timeoutIntervalInSeconds, long sleepIntervalInSeconds) {
        PlaywrightAssertions.assertThat(wrappedElement).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(timeoutIntervalInSeconds * 1000));
        return (TElementType)this;
    }
    ...
    public <TElementType extends WebComponent> TElementType toNotBeVisible(long timeoutIntervalInSeconds, long sleepIntervalInSeconds) {
        PlaywrightAssertions.assertThat(wrappedElement).not().isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(timeoutIntervalInSeconds * 1000));
        return (TElementType)this;
    }
    ...
    public <TElementType extends WebComponent> TElementType toBeDisabled(long timeoutIntervalInSeconds, long sleepIntervalInSeconds) {
        PlaywrightAssertions.assertThat(wrappedElement).isDisabled(new LocatorAssertions.IsDisabledOptions().setTimeout(timeoutIntervalInSeconds * 1000));
        return (TElementType)this;
    }
    ...
    public <TElementType extends WebComponent> TElementType toHaveContent(long timeoutIntervalInSeconds, long sleepIntervalInSeconds) {
        PlaywrightAssertions.assertThat(wrappedElement).not().isEmpty(new LocatorAssertions.IsEmptyOptions().setTimeout(timeoutIntervalInSeconds * 1000));
        return (TElementType)this;
    }
