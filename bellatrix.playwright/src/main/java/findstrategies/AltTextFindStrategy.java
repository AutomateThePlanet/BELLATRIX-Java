...
import findstrategies.options.AltTextOptions;
...
@Getter
public class AltTextFindStrategy extends PatternStrategy {
    public AltTextFindStrategy(String text) {
        this.text = text;
    }

    public AltTextFindStrategy(Pattern pattern) {
        this.pattern = pattern;
    }

    public AltTextFindStrategy(String text, AltTextOptions options) {
        this.text = text;
        this.options = options;
    }

    public AltTextFindStrategy(Pattern pattern, AltTextOptions options) {
        this.pattern = pattern;
        this.options = options;
    }
