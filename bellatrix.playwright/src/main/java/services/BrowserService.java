...
public class BrowserService extends WebService {
    ...
    // ToDo public void waitNumberOfWindowsToBe(int numberOfWindows);
    //
    ...
    // ToDo instead of Validator.validateCondition() maybe the native playwright method Page.waitForCondition() could be used;
