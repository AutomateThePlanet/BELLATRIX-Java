...
public class IdFindStrategy extends FindStrategy {
    ...
    public WebElement findElement(AndroidDriver driver) {
        return driver.findElement(AppiumBy.androidUIAutomator(String.format(ID_EXPRESSION, getValue())));
    }

    @Override
    public List<WebElement> findAllElements(AndroidDriver driver) {
        return driver.findElements(AppiumBy.androidUIAutomator(String.format(ID_EXPRESSION, getValue())));
    }
