...
public class IdContainingFindStrategy extends FindStrategy {
    ...
    public MobileElement findElement(AndroidDriver<MobileElement> driver) {
        return driver.findElementByAndroidUIAutomator(String.format(ID_CONTAINING_EXPRESSION, getValue()));
    }

    @Override
    public List<MobileElement> findAllElements(AndroidDriver<MobileElement> driver) {
        return driver.findElementsByAndroidUIAutomator(String.format(ID_CONTAINING_EXPRESSION, getValue()));
    }
