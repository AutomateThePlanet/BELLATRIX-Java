...
public class DescriptionContainingFindStrategy extends FindStrategy {
    ...
    public MobileElement findElement(AndroidDriver<MobileElement> driver) {
        return driver.findElementByAndroidUIAutomator(String.format(DESCRIPTION_CONTAINING_EXPRESSION, getValue()));
    }

    @Override
    public List<MobileElement> findAllElements(AndroidDriver<MobileElement> driver) {
        return driver.findElementsByAndroidUIAutomator(String.format(DESCRIPTION_CONTAINING_EXPRESSION, getValue()));
    }
