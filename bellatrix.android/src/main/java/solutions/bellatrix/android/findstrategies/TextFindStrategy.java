...
public class TextFindStrategy extends FindStrategy {
    ...
    public WebElement findElement(AndroidDriver driver) {
        return driver.findElement(MobileBy.androidUIAutomator(String.format(TEXT_EXPRESSION, getValue())));
    }

    @Override
    public List<WebElement> findAllElements(AndroidDriver driver) {
        return driver.findElements(MobileBy.androidUIAutomator(String.format(TEXT_EXPRESSION, getValue())));
    }
