...
public interface ComponentSrc extends Component {
    ...
    default void validateSrcIs(String value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getSrc(), value, "src");
    }
    ...
    default void validateSrcIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getSrc(), "src");
    }
