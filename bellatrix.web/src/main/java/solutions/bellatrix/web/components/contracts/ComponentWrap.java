...
public interface ComponentWrap extends Component {
    ...
    default void validateWrapIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getWrap(), "wrap");
    }
    ...
    default void validateWrapIs(int value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getWrap(), value, "wrap");
    }
}
