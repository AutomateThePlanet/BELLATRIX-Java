...
public interface ComponentList extends Component {
    ...
    default void validateListIs(String value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getList(), value, "list");
    }
    ...
    default void validateListIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getList(), "list");
    }
