...
public class BddToastNotificationsLogging extends Listener {
    ...
    public void addListener() {
        ...
        if (isBddLoggingTurnedOn) {
            ...
            EmailField.SETTING_EMAIL.addListener((x) -> new BrowserService().injectInfoNotificationToast("typing '%s' in %s", x.getActionValue(), x.getComponent().getComponentName()));
            ...
            PasswordField.SETTING_PASSWORD.addListener((x) -> new BrowserService().injectInfoNotificationToast("typing '%s' in %s", x.getActionValue(), x.getComponent().getComponentName()));
            PhoneField.SETTING_PHONE.addListener((x) -> new BrowserService().injectInfoNotificationToast("typing '%s' in %s", x.getActionValue(), x.getComponent().getComponentName()));
            ...
            TextField.SETTING_TEXT.addListener((x) -> new BrowserService().injectInfoNotificationToast("typing '%s' in %s", x.getActionValue(), x.getComponent().getComponentName()));
