...
public interface ComponentAlt extends Component {
    ...
    default void validateAltIs(String value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getAlt(), value, "alt");
    }
    ...
    default void validateAltIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getAlt(), "alt");
    }
