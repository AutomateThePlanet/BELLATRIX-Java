...
public interface ComponentHeight extends Component {
    ...
    default void validateHeightIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getHeight(), "height");
    }
    ...
    default void validateHeightIs(int value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getHeight(), value, "height");
    }
}
