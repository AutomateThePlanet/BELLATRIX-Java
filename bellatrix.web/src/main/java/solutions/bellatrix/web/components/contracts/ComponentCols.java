...
public interface ComponentCols extends Component {
    ...
    default void validateColsIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getCols(), "cols");
    }
    ...
    default void validateColsIs(int value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getCols(), value, "cols");
    }
}
