...
public interface ComponentMax extends Component {
    ...
    default void validateMaxIsSet() {
        try {
            ...
            method.invoke(SingletonFactory.getInstance(ComponentValidator.class), (WebComponent)this, (Supplier<Object>)this::getMax, "max");
    ...
    default void validateMaxIs(Number value) {
        try {
            ...
            method.invoke(SingletonFactory.getInstance(ComponentValidator.class), (WebComponent)this, (Supplier<Object>)this::getMax, value, "max");
        } catch (InvocationTargetException e) {
            throw e.getCause();
        }
    }
