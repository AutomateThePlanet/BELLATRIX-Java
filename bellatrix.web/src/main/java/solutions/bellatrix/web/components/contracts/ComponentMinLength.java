...
public interface ComponentMinLength extends Component {
    ...
    default void validateMinLengthIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getMinLength(), "min length");
    }
    ...
    default void validateMinLengthIs(int value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getMinLength(), value, "min length");
    }
}
