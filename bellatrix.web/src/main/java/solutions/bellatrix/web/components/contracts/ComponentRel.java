...
public interface ComponentRel extends Component {
    ...
    default void validateRelIs(String value) {
        try {
            ...
            method.invoke(SingletonFactory.getInstance(ComponentValidator.class), (WebComponent)this, (Supplier<String>)this::getRel, value, "rel");
    ...
    default void validateRelIsSet() {
        try {
            ...
            method.invoke(SingletonFactory.getInstance(ComponentValidator.class), (WebComponent)this, (Supplier<String>)this::getRel, "rel");
        } catch (InvocationTargetException e) {
            throw e.getCause();
        }
    }
