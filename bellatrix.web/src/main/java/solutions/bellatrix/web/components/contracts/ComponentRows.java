...
public interface ComponentRows extends Component {
    ...
    default void validateRowsIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getRows(), "rows");
    }
    ...
    default void validateRowsIs(int value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getRows(), value, "rows");
    }
}
