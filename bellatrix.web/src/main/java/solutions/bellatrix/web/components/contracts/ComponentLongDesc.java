...
public interface ComponentLongDesc extends Component {
    ...
    default void validateLongDescIs(String value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getLongDesc(), value, "longdesc");
    }
    ...
    default void validateLongDescIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getLongDesc(), "longdesc");
    }
