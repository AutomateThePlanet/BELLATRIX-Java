...
public interface ComponentFor extends Component {
    ...
    default void validateForIs(String value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getFor(), value, "for");
    }
    ...
    default void validateForIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getFor(), "for");
    }
