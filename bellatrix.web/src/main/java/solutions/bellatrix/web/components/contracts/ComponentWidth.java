...
public interface ComponentWidth extends Component {
    ...
    default void validateWidthIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getWidth(), "width");
    }
    ...
    default void validateWidthIs(int value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getWidth(), value, "width");
    }
}
