...
public interface ComponentTabIndex extends Component {
    ...
    default void validateTabIndexIs(String value) {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getTabIndex(), value, "tabindex");
    }
    ...
    default void validateTabIndexIsSet() {
        ...
        method.invoke(SingletonFactory.getInstance(WebValidator.class), (WebComponent)this, getTabIndex(), "tabindex");
    }
