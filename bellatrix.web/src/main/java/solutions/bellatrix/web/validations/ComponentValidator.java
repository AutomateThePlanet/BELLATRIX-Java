...
public class ComponentValidator {
    ...
    public void defaultValidateAttributeIsNull(WebComponent component, Object property, String attributeName) {
        ...
        WebComponent.VALIDATED_ATTRIBUTE.broadcast(new ComponentActionEventArgs(component, null, String.format("validating %s's %s is null", component.getComponentName(), attributeName)));
    }
    ...
    public void defaultValidateAttributeNotNull(WebComponent component, Object property, String attributeName) {
        ...
        WebComponent.VALIDATED_ATTRIBUTE.broadcast(new ComponentActionEventArgs(component, null, String.format("validating %s's %s is set", component.getComponentName(), attributeName)));
    }
    ...
    public void defaultValidateAttributeIs(WebComponent component, String property, String value, String attributeName) {
        ...
        WebComponent.VALIDATED_ATTRIBUTE.broadcast(new ComponentActionEventArgs(component, value, String.format("validating %s's %s is '%s'", component.getComponentName(), attributeName, value)));
    }
    ...
    public void defaultValidateAttributeIs(WebComponent component, Number property, Number value, String attributeName) {
        ...
        WebComponent.VALIDATED_ATTRIBUTE.broadcast(new ComponentActionEventArgs(component, value.toString(), String.format("validating %s's %s is '%s'", component.getComponentName(), attributeName, value)));
    }
    ...
    public void defaultValidateAttributeContains(WebComponent component, String property, String value, String attributeName) {
        ...
        WebComponent.VALIDATED_ATTRIBUTE.broadcast(new ComponentActionEventArgs(component, value, String.format("validating %s's %s contains '%s'", component.getComponentName(), attributeName, value)));
    }
    ...
    public void defaultValidateAttributeNotContains(WebComponent component, String property, String value, String attributeName) {
        ...
        WebComponent.VALIDATED_ATTRIBUTE.broadcast(new ComponentActionEventArgs(component, value, String.format("validating %s's %s doesn't contain '%s'", component.getComponentName(), attributeName, value)));
    }
    ...
    public void defaultValidateAttributeTrue(WebComponent component, boolean property, String attributeName) {
        ...
        WebComponent.VALIDATED_ATTRIBUTE.broadcast(new ComponentActionEventArgs(component, null, String.format("validating %s is %s", component.getComponentName(), attributeName)));
    }
    ...
    public void defaultValidateAttributeFalse(WebComponent component, boolean property, String attributeName) {
        ...
        WebComponent.VALIDATED_ATTRIBUTE.broadcast(new ComponentActionEventArgs(component, null, String.format("validating %s is not %s", component.getComponentName(), attributeName)));
    }
